  ...
  return (
    <Canvas className='left' camera={{ position: [10, 12, 12], fov: 25 }} style={{ border: "1px solid red" }}>
      <group position={[0, 0, 0]}>
        ...
        <Line
          points={[[0.0, 0.0, 0.0], 
                  [0.6710100716628343, 0.7393390827408323, -0.055885637322863]]}
          color="red" 
          lineWidth={2}  
          segments
        />
        <Line
          points={[[0.0, 0.0, 0.0], 
                  [-0.4698463103929542, 0.4823092009718169, 0.7393390827408323]]}
          color="green" 
          lineWidth={2}  
          segments
        />
        <Line
          points={[[0.0, 0.0, 0.0], 
                  [0.573576436351046, -0.4698463103929542, 0.6710100716628343]]}
          color="blue" 
          lineWidth={2}  
          segments
        />
